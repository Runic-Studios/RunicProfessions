...
public class BlacksmithItems {
    ...
    public static final ItemStack WHETSTONE_ITEMSTACK = WHETSTONE.generateItem();
    ...
    public static final ItemStack OAKEN_SHIELD_ITEMSTACK = OAKEN_SHIELD.generateItem();
    ...
    public static final ItemStack FORGED_IRON_BROADSWORD_ITEMSTACK = FORGED_IRON_BROADSWORD.generateItem();
    ...
    public static final ItemStack FORGED_IRON_REAVER_ITEMSTACK = FORGED_IRON_REAVER.generateItem();
    ...
    public static final ItemStack FORGED_MAIL_GREAVES_ITEMSTACK = FORGED_MAIL_GREAVES.generateItem();
    ...
    public static final ItemStack FORGED_GILDED_BOOTS_ITEMSTACK = FORGED_GILDED_BOOTS.generateItem();
    ...
    public static final ItemStack FORGED_MAIL_TASSEST_ITEMSTACK = FORGED_MAIL_TASSEST.generateItem();
    ...
    public static final ItemStack FORGED_IRON_PLATELEGS_ITEMSTACK = FORGED_IRON_PLATELEGS.generateItem();
    ...
    public static final ItemStack FLAIL_OF_RETRIBUTION_ITEMSTACK = FLAIL_OF_RETRIBUTION.generateItem();
    ...
    public static final ItemStack ILLUSIONERS_WAND_ITEMSTACK = ILLUSIONERS_WAND.generateItem();
    ...
    public static final ItemStack ETCHED_DAGGER_ITEMSTACK = ETCHED_DAGGER.generateItem();
    ...
    public static final ItemStack SHARPENING_STONE_ITEMSTACK = SHARPENING_STONE.generateItem();

    // level 30
    public static final RunicItemOffhand BASTION = (RunicItemOffhand) RunicItemsAPI.generateItemFromTemplate("blacksmith-bastion");
    public static final ItemStack BASTION_ITEMSTACK = BASTION.generateItem();
    ...
    public static final ItemStack FORGED_IRON_LONGBOW_ITEMSTACK = FORGED_IRON_LONGBOW.generateItem();
    ...
    public static final ItemStack FORGED_IRON_SCEPTER_ITEMSTACK = FORGED_IRON_SCEPTER.generateItem();
    ...
    public static final ItemStack FORGED_GILDED_BODY_ITEMSTACK = FORGED_GILDED_BODY.generateItem();
    ...
    public static final ItemStack FORGED_IRON_PLATEBODY_ITEMSTACK = FORGED_IRON_PLATEBODY.generateItem();
    ...
    public static final ItemStack FORGED_MAIL_HELM_ITEMSTACK = FORGED_MAIL_HELM.generateItem();
    ...
    public static final ItemStack FORGED_IRON_HELM_ITEMSTACK = FORGED_IRON_HELM.generateItem();
    ...
    public static final ItemStack STORMSONG_ITEMSTACK = STORMSONG.generateItem();

    public static final RunicItemWeapon VALKYRIE = (RunicItemWeapon) RunicItemsAPI.generateItemFromTemplate("blacksmith-valkyrie");
    public static final ItemStack VALKYRIE_ITEMSTACK = VALKYRIE.generateItem();
    ...
    public static final ItemStack THE_MINOTAUR_ITEMSTACK = THE_MINOTAUR.generateItem();
    ...
    public static final ItemStack FROST_LORDS_BULWARK_ITEMSTACK = FROST_LORDS_BULWARK.generateItem();
    ...
    public static final ItemStack REDEEMERS_FLAIL_ITEMSTACK = REDEEMERS_FLAIL.generateItem();
    ...
    public static final ItemStack ICEFURY_WAND_ITEMSTACK = ICEFURY_WAND.generateItem();
    ...
    public static final ItemStack BLACK_STEEL_DIRK_ITEMSTACK = BLACK_STEEL_DIRK.generateItem();
}
